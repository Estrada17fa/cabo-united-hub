...
/* ---------- Premios: carousel card ---------- */
function PrizesCarouselCard() {
  const [index, setIndex] = useState(0);
  ...
  return (
    ...
    >
      ...
      {/* Carousel image + info */}
      <div className="relative flex-1 mx-3 rounded-xl overflow-hidden border" style={{ borderColor: "rgba(255,255,255,0.07)", minHeight: 240 }}>
        <AnimatePresence mode="wait">
          <motion.div
            key={index}
